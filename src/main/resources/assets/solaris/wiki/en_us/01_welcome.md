...
Use the Waypoints button to add, rename, or jump to a saved location. Waypoints can be shared
with your guild if Phoenix Guilds is installed.
...
- **Export as PNG** saves a snapshot of the currently explored area.
- **Export for Web Map** produces a tile set for viewing the map in a browser.
